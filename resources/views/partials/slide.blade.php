        ...
        <div id="rev_slider_3" class="rev_slider" data-version="5.4.5">
            <ul>
                ...
                <li data-transition="random" data-masterspeed="1000">
                    ...
                    <img src="images/slider/imagen1.jpg" alt="Sky" class="rev-slidebg">
                    ...
                    >BIENVENIDOS A WONDER GROUP</div>
                    ...
                    <div class="tp-caption tp-resizeme normalWraping layer_3"
                         ...
                         data-fontweight="400"
                         data-textAlign="center"
                    ><a href="#" target="_blank" class="common_btn"><span>COTIZAR</span></a></div>
                </li>
                <li data-transition="random" data-masterspeed="1000">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="images/slider/imagen2.jpg" alt="Sky" class="rev-slidebg">
                    <div class="tp-caption tp-resizeme normalWraping layer_1"
                         ...
                         data-color="#FFF"
                         data-textAlign="center"
                    >FUNDAMENTAL PARA TUS IDEAS</div>
                    <div class="tp-caption tp-resizeme normalWraping layer_2"
                         ...
                         data-color="#FFF"
                         data-textAlign="center"
                    >UN SONIDO<br> DE ALTA FIDELIDAD</div>
                    <div class="tp-caption tp-resizeme normalWraping layer_3"
                         ...
                         data-fontweight="400"
                         data-textAlign="center"
                    ><a href="#" class="common_btn"><span>COTIZAR</span></a></div>
                </li>
                <li data-transition="random" data-masterspeed="1000">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="images/slider/imagen3.jpg" alt="Sky" class="rev-slidebg">
                    <div class="tp-caption tp-resizeme normalWraping layer_1"
                         ...
                         data-color="#FFF"
                         data-textAlign="center"
                    >AÚN NO LO SABES PERO NOS NECESITAS</div>
                    <div class="tp-caption tp-resizeme normalWraping layer_2"
